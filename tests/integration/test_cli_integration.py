...
class TestCLIIntegration:
    ...
    def test_doctor_command_integration_mocked_services_full_workflow(self):
        ...
        with (
            ...
            patch("ledzephyr.client.APIClient.test_jira_connection", return_value=True),
            patch("ledzephyr.client.APIClient.test_zephyr_connection", return_value=True),
    ...
    def test_metrics_command_integration_mocked_apis_returns_metrics(self, tmp_path):
        ...
        with patch("ledzephyr.metrics.MetricsCalculator.calculate_metrics") as mock_metrics:
            from ledzephyr.models import ProjectMetrics

            mock_metrics.return_value = ProjectMetrics(
                project_key="DEMO",
                time_window="7d",
                total_tests=150,
                qtest_tests=60,
    ...
    def test_end_to_end_workflow_config_to_output_complete_flow(self, tmp_path):
        ...
        with (
            ...
            patch("ledzephyr.metrics.MetricsCalculator.calculate_metrics") as mock_metrics,
        ):
            ...
            # Mock to return different metrics for different time windows
            def mock_calculate_metrics(project_key, time_window, teams_source):
                if time_window == "24h":
            ...
            mock_metrics.side_effect = mock_calculate_metrics
